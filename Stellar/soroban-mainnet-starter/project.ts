...
const project: StellarProject = {
  ...
  network: {
     ...
     */
    endpoint: ["https://horizon.stellar.lobstr.co"],
    /* This is a specific Soroban endpoint
      It is only required when you are using a soroban/EventHandler */
    sorobanEndpoint: "https://mainnet.sorobanrpc.com", // This one works 
    //sorobanEndpoint: "https://stellar-soroban-public.nodies.app", // This one doesn't work
  },
  dataSources: [
    {
        ...
        handlers: [
          {
            ...
            filter: {
              /* You can optionally specify a smart contract address here
                contractId: "" */
              topics: [
                "deployed", // Topic signature(s) for the events, there can be up to 4
              ],
            },
          },
        ],
